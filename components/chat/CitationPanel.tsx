...
import { useTransactionForCitation } from '@/hooks/useCitation';
...
export function CitationPanel({
  ...
  // Load transaction data for the citation to check for documents
  const { transaction, hasDocument } = useTransactionForCitation(
    citation?.transactionId ?? null
  );
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-1 flex-col overflow-y-auto">
          {/* Document preview - uses actual DocumentThumbnail when document exists */}
